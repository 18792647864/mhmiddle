var ArticleSQL=
    {
        insert :'insert into mh_article(title,introduction,release_time,uId,categoryId,isdraft) values(?,?,?,?,?,?)',
        ...
        '\tand users.uid = a.uId\n' +
        '\tand cate.category_id = a.categoryId and a.isdraft = ?',
        queryUserAll :'select a.article_id,a.categoryId,a.introduction,a.title,a.uId,a.release_time,ac.content_id,a.count_comments,a.count_likes,users.nickname,cate.name as categoryname\n' +
        'from mh_article a,mh_article_content ac,mh_user users,mh_category cate\n' +
        'where a.article_id = ac.article_id \n' +
        '\tand users.uid = a.uId\n' +
